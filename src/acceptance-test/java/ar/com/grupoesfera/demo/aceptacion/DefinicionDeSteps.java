...
public class DefinicionDeSteps {
	...
	public void noExisteElCliente(String nombreCliente) {
		Response respuesta =  get("http://10.26.160.25:8080/clients/v1.0/?name=" + nombreCliente);
	...
	public void creoElCliente(String nombreCliente) {
		...
		given()
			...
			.contentType(ContentType.JSON).
		when()
			.post("http://10.26.160.25:8080/clients/v1.0").
		then()
			.statusCode(HttpStatus.SC_OK);	
	}
	...
	public void elListadoDeClientesIncluyeA(String nombreCliente) {
		when()
			.get("http://10.26.160.25:8080/clients/v1.0/?name=" + nombreCliente).
		then()
			.statusCode(HttpStatus.SC_OK)
